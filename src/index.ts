...
const gamecube_list = ['007 - Agent Under Fire', '007 - Everything or Nothing', '007 - From Russia with Love', '007 - Nightfire', '1080 Avalanche', '18 Wheeler - American Pro Trucker', '2002 FIFA World Cup', '2006 FIFA World Cup', '4x4 Evo 2', ' The - Boy Genius - Attack of the Twonkies (USA)', ' The - Boy Genius - Jet Fusion (USA)', ' The - Boy Genius (USA)', 'Aggressive Inline', 'Alien Hominid', 'All-Star Baseball 2002', 'All-Star Baseball 2003', 'All-Star Baseball 2004', 'Amazing Island', 'American Chopper 2 - Full Throttle', 
'Animal Crossing', 'Animaniacs - The Great Edgar Hunt', ' The (USA)', 'Aquaman - Battle for Atlantis', 'Army Men - Air Combat - The Elite Missions', 'Army Men - RTS', 'Army Men - Sarge\\\'s War', 'Asterix & Obelix XXL', 'ATV - Quad Power Racing 2', 'Auto Modellista', 'Avatar - The Last Airbender', 'Backyard Baseball', 'Backyard Baseball 2007', 'Backyard Football', 'Bad Boys - Miami Takedown', 'Baldur\\\'s Gate - Dark Alliance', 'Barnyard', 'Baten Kaitos - Eternal Wings and the Lost Ocean  Disk 1', 'Baten Kaitos - Eternal Wings and the Lost Ocean  Disk 2', 'Baten Kaitos Origins  Disk 1', 'Baten Kaitos Origins  Disk 2', 'Batman - Dark Tomorrow', 'Batman - Rise of Sin Tzu', 'Batman - Vengeance', 'Batman Begins', 'Battalion Wars', 'Battle Stadium D.O.N', 'Beach Spikers - Virtua Beach Volleyball', 'Beyblade VForce - Super Tournament Battle', 'Beyond Good & Evil', 
'Big Air Freestyle', 'Big Mutha Truckers', 'Billy Hatcher and the Giant Egg', 'Bionicle', 'Bionicle Heroes', 'Black & Bruised', 'Bleach GC - Tasogare Ni Mamieru Shinigami', 'BloodRayne', 'Bloody Roar - Primal Fury', 'Blowout', 'BMX XXX', 'Boboboubo Boubobo Dassutsu! Hajike Royale', 'Bomber Man Land 2', 'Bomberman Generation', 'Bomberman Jetters', 'Bratz - Forever Diamondz', 'Bratz - Rock Angelz',
...
'Carmen Sandiego - The Secret of the Stolen Drums', 'Casper - Spirit Dimensions', 'Catwoman', 'Cel Damage', 'Chaos Field', 'Charinko Hero', 'Charlie and the Chocolate Factory', 'Charlie\\\'s Angels', 'Chibi-Robo! - Plug into Adventure', ' The - The Lion', 'City Racer', 'Cocoto Funfair', 'Cocoto Kart Racer', 'Cocoto Platform Jumper', 'Codename - Kids Next Door - Operation - V.I.D.E.O.G.A.M.E.', 'Conan  Disk 1', 
'Conan  Disk 2', 'Conflict - Desert Storm', 'Conflict - Desert Storm II - Back to Baghdad', 'Crash Bandicoot - The Wrath of Cortex', 'Crash Nitro Kart', 'Crash Tag Team Racing', 'Crazy Taxi', 'Cubivore', 'Cubix Robots for Everyone - Showdown', 'Curious George', 'Custom Robo', 'Dakar 2 - The World\\\'s Ultimate Rally', 'Dance Dance Revolution - Mario Mix', 'Dark Summit', 'Darkened Skye', 'Dave Mirra Freestyle BMX 2',
 'Dead to Rights', 'Def Jam - Fight for NY', 'Def Jam - Vendetta', 'Defender', 'Die Hard - Vendetta', 'Digimon Rumble Arena 2', 'Digimon World 4', 'Dinotopia - The Sunstone Odyssey', 'Disney Sports - Basketball', 'Disney Sports - Football', 'Disney Sports - Skateboarding', 'Disney Sports - Soccer', 'Disney-Pixar Cars', 'Disney-Pixar Finding Nemo', ' Inc. - Scream Arena (USA)', 'Disney-Pixar Ratatouille', 'Disney\\\'s Chicken Little',
 'Disney\\\'s Donald Duck - Goin\\\' Quackers', 'Disney\\\'s Extreme Skate Adventure', 'Disney\\\'s Hide & Sneak', 'Disney\\\'s Magical Mirror Starring Mickey Mouse', 'Disney\\\'s Meet the Robinsons', 'Disney\\\'s Party', 'Disney\\\'s PK - Out of the Shadows', 'Disney\\\'s Tarzan Untamed', 'Disney\\\'s The Haunted Mansion', 'Donkey Kong Jungle Beat', 'Donkey Konga', 'Donkey Konga 2', 'Donkey Konga 3', 'Dora the Explorer - Journey to the Purple Planet', 
 'Doraemon - Minna de Asobou! Miniland', 'Doshin the Giant', 'Dr. Muto', 'Dragon Ball Z - Budokai', 'Dragon Ball Z - Budokai 2', 'Dragon Ball Z - Sagas', 'Dragon Drive - D-Masters Shot', 'Dragon\\\'s Lair 3D - Return to the Lair', 'DreamMix TV - World Fighters', 'Driven', 'Drome Racers', ' Edd n Eddy - The Mis-Edventures (USA)', 'Egg Mania - Eggstreme Madness', 'Enter the Matrix  Disk 1', 'Enter the Matrix  Disk 2', 
 'ESPN International Winter Sports 2002', 'ESPN MLS ExtraTime 2002', 'Eternal Darkness - Sanity\\\'s Requiem', 'Evolution Skateboarding', 'Evolution Snowboarding', 'Evolution Worlds', 'F-Zero GX', 'F1 2002', 'F1 Career Challenge', ' The - Breakin\\\' da Rules (USA)', ' The - Shadow Showdown (USA)', 'Fantastic 4', 'FIFA Soccer 06', 'FIFA Soccer 07', 'FIFA Soccer 2002', 'FIFA Soccer 2003', 'FIFA Soccer 2004', 'FIFA Soccer 2005', 
 'FIFA Street', 'FIFA Street 2', 'Fight Night Round 2', 'Final Fantasy - Crystal Chronicles', 'Fire Emblem - Path of Radiance', 'Fireblade', 'Flushed Away', 'Franklin - A Birthday Surprise', 'Freaky Flyers  Disk 1', 'Freaky Flyers  Disk 2', 'Freedom Fighters', 'Freekstyle', 
'Freestyle MetalX', 'Freestyle Street Soccer', 'Frogger - Ancient Shadow', 'Frogger Beyond', 'Frogger\\\'s Adventures - The Rescue', 'Future Tactics - The Uprising', 'Gauntlet - Dark Legacy', 'Geist', 'Gladius', 'Go! Go! Hypergrind', 'Goblin Commander - Unleash the Horde', 'Godzilla - Destroy All Monsters Melee', 'GoldenEye - Rogue Agent  Disk 1', 'GoldenEye - Rogue Agent  Disk 2', 'Gotcha Force', ' The (USA)', 
'Grooverider - Slot Car Thunder', 'GT Cube', 'Gun', 'Happy Feet', 'Harry Potter - Quidditch World Cup', 'Harry Potter and the Chamber of Secrets', 'Harry Potter and the Goblet of Fire', 'Harry Potter and the Prisoner of Azkaban', 'Harry Potter and the Sorcerer\\\'s Stone', 'Harvest Moon - A Wonderful Life', 'Harvest Moon - Another Wonderful Life', 'Harvest Moon - Magical Melody', 'Hello Kitty - Roller Rescue', 
'Hitman 2 - Silent Assassin', ' The (USA)', 'Home Run King', 'Hot Wheels - Velocity X', 'Hot Wheels - World Race', 'Hudson Selection Vol.1 - Cubic Lode Runner', 'Hudson Selection Vol.2 - Star Soldier', 'Hudson Selection Vol.3 - PC Genjin - Pithecanthropus Computerurus', 'Hudson Selection Vol.4 - Takahashi-Meijin no Boukenjima', 'Hulk', 'Hunter - The Reckoning', 'I-Ninja', 'Ice Age 2 - The Meltdown', 'Ikaruga', 
' The - Ultimate Destruction (USA)', ' The - Rise of the Underminer (USA)', ' The (USA)', 'Intellivision Lives!', 'International Superstar Soccer 2', 'International Superstar Soccer 3', ' The (USA)', 'Jeremy McGrath Supercross World', 'Jikkyou World Soccer 2002', 'Judge Dredd - Dredd vs Death', 
'Kao the Kangaroo - Round 2', 'Karaoke Revolution Party', 'Kelly Slater\\\'s Pro Surfer', 'Kidou Senshi Gundam - Gundam vs. Z Gundam', 'Killer7  Disk 1', 'Killer7  Disk 2', 'King Arthur', 'Kirby Air Ride', 'Knights of the Temple - Infernal Crusade', 'Knockout Kings 2003', 'Konjiki no Gashbell!! Go! Go! Mamono Fight!!', 'Konjiki no Gashbell!! Yuujyo Tag Battle - Full Power', 
'Konjiki no Gashbell!! Yuujyo Tag Battle 2', 'Korokke! Ban-Ou no Kiki o Sukue', 'Kururin Squash!', 'Lara Croft Tomb Raider - Legend', 'Largo Winch - Empire Under Threat', ' The - Blood Omen 2 (USA)', ' The - A New Beginning (USA)', ' The - Collector\\\'s Edition (USA)', ' The - Four Swords Adventures (USA)', ' The - Ocarina of Time - Master Quest (USA)', ' The - The Wind Waker (USA)', 
' The - Twilight Princess (USA)', 'Legends of Wrestling', 'Legends of Wrestling II', 'LEGO Star Wars - The Video Game', 'LEGO Star Wars II - The Original Trilogy', 'Lemony Snicket\\\'s A Series of Unfortunate Events', 'Looney Tunes - Back in Action', ' The - The Return of the King (USA)', ' The - The Third Age (USA) (Disc 1)', ' The - The Third Age (USA) (Disc 2)', ' The - The Two Towers (USA)', 
'Lost Kingdoms', 'Lost Kingdoms II', 'Lotus Challenge', 'Luigi\\\'s Mansion', 'Madagascar', 'Madden NFL 06', 'Madden NFL 07', 'Madden NFL 08', 'Madden NFL 2002', 'Madden NFL 2003', 'Madden NFL 2004', 'Madden NFL 2005', 
'Major League Baseball 2K6', 'Mario Golf - Toadstool Tour', 'Mario Kart - Double Dash!!', 'Mario Party 4', 'Mario Party 5', 'Mario Party 6', 'Mario Party 7', 'Mario Power Tennis', 'Mario Superstar Baseball', 'Mark Davis Pro Bass Challenge', 
'Marvel Nemesis - Rise of the Imperfects', 'Mary-Kate and Ashley - Sweet 16 - Licensed to Drive', 'Mat Hoffman\\\'s Pro BMX 2', 'Maxplay Classic Games Volume 1', 'MC Groovz Dance Craze', 'Medabots Infinity', 'Medal of Honor - European Assault', 'Medal of Honor - Frontline', 'Medal of Honor - Rising Sun  Disk 1', 'Medal of Honor - Rising Sun  Disk 2', 'Mega Man - Network Transmission', 'Mega Man Anniversary Collection',
 'Mega Man X - Command Mission', 'Mega Man X Collection', 'Men in Black II - Alien Escape', 'Metal Arms - Glitch in the System', 'Metal Gear Solid - The Twin Snakes  Disk 1', 'Metal Gear Solid - The Twin Snakes  Disk 2', 'Metroid Prime', 'Metroid Prime 2 - Echoes', 'Micro Machines', 'Midway Arcade Treasures', 'Midway Arcade Treasures 2', 'Midway Arcade Treasures 3', 'Minority Report - Everybody Runs', 'Mission Impossible - Operation Surma', 'MLB SlugFest 2003', 'MLB SlugFest 2004', 'Monopoly Party', 'Monster 4x4 - Masters of Metal', 'Monster House', 'Monster Jam - Maximum Destruction', 'Mortal Kombat - Deadly Alliance', 'Mortal Kombat - Deception', 
'Mr. Driller - Drill Land', 'Muppets - Party Cruise', 'MVP Baseball 2004', 'MVP Baseball 2005', 'MX Superfly Featuring Ricky Carmichael', 'Mystic Heroes', 'Namco Museum - 50th Anniversary', 'Namco Museum', 'Naruto - Clash of Ninja', 'Naruto - Clash of Ninja 2', 'Naruto - Gekitou Ninja Taisen! 3', 'Naruto - Gekitou Ninja Taisen! 4', 'NASCAR - Dirt to Daytona', 'NASCAR 2005 - Chase for the Cup', 'NASCAR Thunder 2003', 'NBA 2K2', 
'NBA 2K3', 'NBA Courtside 2002', 'NBA Live 06', 'NBA Live 2003', 'NBA Live 2004', 'NBA Live 2005', 'NBA Street', 'NBA Street V3', 'NBA Street Vol. 2', 'NCAA College Basketball 2K3', 'NCAA College Football 2K3', 'NCAA Football 2003', 'NCAA Football 2004', 'NCAA Football 2005', 'Need for Speed - Carbon', 'Need for Speed - Hot Pursuit 2', 'Need for Speed - Most Wanted', 'Need for Speed - Underground', 'Need for Speed - Underground 2', 
'Neighbours From Hell', 'NFL 2K3', 'NFL Blitz 2002', 'NFL Blitz 2003', 'NFL Blitz Pro', 'NFL Quarterback Club 2002', 'NFL Street', 'NFL Street 2', 'NHL 06', 'NHL 2003', 'NHL 2004', 'NHL 2005', 'NHL 2K3', 'NHL Hitz 2002', 'NHL Hitz 2003', 'NHL Hitz Pro', 'Nickelodeon Party Blast', 'Nicktoons - Battle for Volcano Island', 'Nicktoons Unite!', 'Nintendo Puzzle Collection', 'Odama', 'One Piece - Grand Adventure', 'One Piece - Grand Battle', 
'One Piece - Grand Battle 3', 'One Piece - Pirates Carnival', 'One Piece - Treasure Battle!', 'Open Season', 'Outlaw Golf', 'Over the Hedge', 'P.N. 03', 'Pac-Man Fever', 'Pac-Man Vs.', 'Pac-Man World 2', 'Pac-Man World 3', 'Pac-Man World Rally', 'Paper Mario - The Thousand-Year Door',
 'Peter Jackson\\\'s King Kong', 'Phantasy Star Online Episode I & II', 'Phantasy Star Online Episode I & II Plus', 'Phantasy Star Online Episode III - C.A.R.D. Revolution', 'Piglet\\\'s Big Game', 'Pikmin', 'Pikmin 2', 'Pinball Hall of Fame - The Gottlieb Collection', 'Pitfall - The Lost Expedition', 'Pokemon Box - Ruby & Sapphire', 'Pokemon Channel', 'Pokemon Colosseum', 'Pokemon XD - Gale of Darkness', ' The (USA)', 'Pool Edge', 'Pool Paradise', 'Power Rangers - Dino Thunder', ' The - Relish Rampage (USA)', 'Prince of Persia - The Sands of Time', 'Prince of Persia - The Two Thrones', 'Prince of Persia - Warrior Within', 'Pro Rally', 'Puyo Pop Fever', 'R - Racing Evolution', 'Radirgy Generic', 
'Rally Championship', 'Rampage - Total Destruction', 'Rave Master', 'Rayman 3 - Hoodlum Havoc', 'Rayman Arena', 'Red Faction II', 'RedCard 2003', 'Rei Fighter Gekitsui Senki', 'Reign of Fire', 'Resident Evil - Code - Veronica X  Disk 1', 'Resident Evil - Code - Veronica X  Disk 2', 'Resident Evil  Disk 1', 'Resident Evil  Disk 2', 'Resident Evil 2', 'Resident Evil 3 - Nemesis', 'Resident Evil 4  Disk 1', 'Resident Evil 4  Disk 2', 'Resident Evil Zero  Disk 1', 'Resident Evil Zero  Disk 2', 'Ribbit King  Disk 1', 'Ribbit King  Disk 2', 'Road Trip - The Arcade Edition', 'RoadKill', 'Robocop - Aratanaru Kiki', 'Robotech - Battlecry', 'Robots', 'Rocket Power - Beach Bandits', 'Rocky', 'Rogue Ops', 
'Rugrats - Royal Ransom', 'Samurai Jack - The Shadow of Aku', 'Scaler', 'Scooby-Doo! - Mystery Mayhem', 'Scooby-Doo! - Night of 100 Frights', 'Scooby-Doo! - Unmasked', ' The - Rise of the Akkadian (USA)', 'SeaWorld Adventure Parks - Shamu\\\'s Deep Sea Adventures', 'Second Sight', 'Sega Soccer Slam', 'Serious Sam - Next Encounter', 'Shadow the Hedgehog', 'Shaman King - Soul Fight', 'Shark Tale', 'Shikigami no Shiro II', 'Shinseiki GPX Cyber Formula - Road to the Evolution', 'Shrek - Extra Large', 'Shrek 2', 'Shrek Smash n\\\' Crash Racing', 'Shrek Super Party', 'Shrek SuperSlam', ' The - Hit & Run (USA)', ' The - Road Rage (USA)', ' The - Pets (USA)', ' The (USA)', ' The - Bustin\\\' Out (USA)', ' The (USA)', 'Skies of Arcadia Legends', 'Smashing Drive', 'Smuggler\\\'s Run - Warzones', 'Sonic Adventure 2 - Battle', 'Sonic Adventure DX - Director\\\'s Cut', 'Sonic Gems Collection', 'Sonic Heroes', 'Sonic Mega Collection', 
'Sonic Riders', 'Soul Calibur II', 'Space Raiders', 'Spartan - Total Warrior', 'Spawn - Armageddon', 'Speed Challenge - Jacques Villeneuve\\\'s Racing Vision', 'Speed Kings', 'Sphinx and the Cursed Mummy', 'Spider-Man', 'Spider-Man 2', 'Spirits & Spells', 'SpongeBob SquarePants - Battle for Bikini Bottom', 'SpongeBob SquarePants - Creature from the Krusty Krab', ' Camera', 'SpongeBob SquarePants - Revenge of the Flying Dutchman', 'SpongeBob SquarePants - The Movie', 'Spy Hunter', 'Spyro - A Hero\\\'s Tail', 'Spyro - Enter the Dragonfly', 'SSX 3', 'SSX On Tour', 'SSX Tricky', 'Star Fox Adventures', 'Star Fox Assault', 'Star Wars - Bounty Hunter', 'Star Wars - Jedi Knight II - Jedi Outcast', 'Star Wars - Rogue Squadron II - Rogue Leader', 'Star Wars - Rogue Squadron III - Rebel Strike', 'Star Wars - The Clone Wars', 'Starsky & Hutch', 'Street Hoops', 
'Street Racing Syndicate', 'Strike Force Bowling', ' The (USA)', 'Summoner - A Goddess Reborn', 'Super Bubble Pop', 'Super Mario Strikers', 'Super Mario Sunshine', 'Super Monkey Ball', 'Super Monkey Ball 2', 'Super Monkey Ball Adventure', 'Super Smash Bros. Melee', 'Superman - Shadow of Apokolips', 'Surf\\\'s Up', 'Swingerz Golf', 'SX Superstar', 'Tak - The Great Juju Challenge', 'Tak 2 - The Staff of Dreams', 'Tak and the Power of Juju', 'Tales of Symphonia  Disk 1', 'Tales of Symphonia  Disk 2', 'Taxi 3', 'Taz - Wanted', 'Teen Titans', 'Teenage Mutant Ninja Turtles', 'Teenage Mutant Ninja Turtles 2 - Battle Nexus  Disk 1', 'Teenage Mutant Ninja Turtles 2 - Battle Nexus  Disk 2', 'Teenage Mutant Ninja Turtles 3 - Mutant Nightmare  Disk 1', 'Teenage Mutant Ninja Turtles 3 - Mutant Nightmare  Disk 2', 'Terminator 3 - The Redemption', 'Tetris Worlds', 'Tiger Woods PGA Tour 06', 
'Tiger Woods PGA Tour 2003', 'Tiger Woods PGA Tour 2004  Disk 1', 'Tiger Woods PGA Tour 2004  Disk 2', 'Tiger Woods PGA Tour 2005  Disk 1', 'Tiger Woods PGA Tour 2005  Disk 2', 'TimeSplitters - Future Perfect', 'TimeSplitters 2', 'TMNT - Mutant Melee', 'TMNT', 'Tom & Jerry in War of the Whiskers', 'Tom Clancy\\\'s Ghost Recon', 'Tom Clancy\\\'s Ghost Recon 2', 'Tom Clancy\\\'s Rainbow Six - Lockdown', 'Tom Clancy\\\'s Rainbow Six 3', 'Tom Clancy\\\'s Splinter Cell - Chaos Theory  Disk 1', 'Tom Clancy\\\'s Splinter Cell - Chaos Theory  Disk 2', 'Tom Clancy\\\'s Splinter Cell - Double Agent  Disk 1', 'Tom Clancy\\\'s Splinter Cell - Double Agent  Disk 2', 'Tom Clancy\\\'s Splinter Cell - Pandora Tomorrow', 'Tom Clancy\\\'s Splinter Cell', 'Tonka - Rescue Patrol', 'Tony Hawk\\\'s American Wasteland', 'Tony Hawk\\\'s Pro Skater 3', 'Tony Hawk\\\'s Pro Skater 4', 
'Tony Hawk\\\'s Underground', 'Tony Hawk\\\'s Underground 2', 'Top Angler - Real Bass Fishing', 'Top Gun - Combat Zones', ' The (Japan)', 'TransWorld Surf - Next Wave', 'Trigger Man', 'True Crime - New York City', 'True Crime - Streets of LA', 'Tube Slider - The Championship of Future Formula', 'Turok - Evolution', 'Ty the Tasmanian Tiger', 'Ty the Tasmanian Tiger 2 - Bush Rescue', 'Ty the Tasmanian Tiger 3 - Night of the Quinkan', 'UEFA Champions League 2004-2005', 'UFC - Throwdown', 'Ultimate Muscle - Legends vs. New Generation', 'Ultimate Spider-Man', 'Universal Studios Theme Parks Adventure', ' The - Sims in the City (USA)', 'V-Rally 3', 'Vexx', 'Viewtiful Joe - Red Hot Rumble', 'Viewtiful Joe', 'Viewtiful Joe 2', 'Virtua Quest', 'Virtua Striker 2002', 'Wallace & Gromit in Project Zoo', 'Wario World', ' Inc. - Mega Party Game$! (USA)', 'Warrior Blade - Rastan vs. Barbarian', 
'Wave Race - Blue Storm', 'Whirl Tour', 'Winnie the Pooh\\\'s Rumbly Tumbly Adventure', 'World Racing', 'World Series of Poker', 'World Soccer Winning Eleven 6 - Final Evolution', 'Worms 3D', 'Worms Blast', 'Wreckless - The Yakuza Missions', 'WTA Tour Tennis', 'WWE Crush Hour', 'WWE Day of Reckoning', 'WWE Day of Reckoning 2', 'WWE Wrestlemania X8', 'WWE Wrestlemania XIX', 'X-Men - Next Dimension', 'X-Men - The Official Game', 'X-Men Legends', 'X-Men Legends II - Rise of Apocalypse', 'X2 - Wolverine\\\'s Revenge', 'XGIII - Extreme G Racing', 'XGRA - Extreme G Racing Association', 'XIII', 'Yu-Gi-Oh! - The Falsebound Kingdom', 'Zapper - One Wicked Cricket!', 'Zatch Bell! - Mamodo Battles', 'Zatch Bell! - Mamodo Fury', 'Zoids - Battle Legends', 'Zoids - Full Metal Crash', 'Zoids Vs.', 'Zoids Vs. III', 'ZooCube'];
...
{
  const gamecubeName = gamecube_list[Math.floor(Math.random() * gamecube_list.length)];
  const avatarURL = client.user.avatarURL() || undefined;
  const embed = new Discord.MessageEmbed()
    .setAuthor(client.user.username || packageJson().name, avatarURL)
    .setThumbnail(avatarURL as string)
    .addField('GameCube', `${gamecubeName}`);
  return { embeds: [embed] };
}
